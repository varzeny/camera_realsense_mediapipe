...
def visualize(image, detection_result) -> np.ndarray:
    global origin_x, origin_y, width, height, category_names
    for detection in detection_result.detections:
        ...
        # for category_one in detection.categories[0].category_name:
        #     print(category_one)
        #     if category_one not in category_names:
        #         category_names.append(category_one)
